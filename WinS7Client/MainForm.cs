...
namespace WinS7Client
{
    public partial class MainForm : Form
    {
        ...
        private const int DB_DAT_N2_Length = 480;
        private const int DB_DAT_Werkzeug_Length = 230;
        private const int DB_DAT_MWerkzeug_Length = 40;
        private const int DB_Service_WKZ_Liste_Length = 3072;
        private const int DB_Service_PlcToPc_Length = 62;
        ...
        private void ShowResult(int result, S7Client client)
        {
            ...
            tbTextError.Text = DateTime.Now + " - " + client.ErrorText(result);
            if (result == 0)
                tbTextError.Text = tbTextError.Text + " (" + client.ExecutionTime.ToString() + " ms)";
        }
